...
namespace SharpC64
{
    internal partial class DigitalRenderer : SIDRenderer
    {
        ...
        public override short[] GetAudioBuffer()
        {
            return sound_buffer;
        }
        ...
        public override void VBlank()
        {
            ...
            {
                AudioBufferCallback(sound_buffer, sndbufsize);
                return;
            }
            */
            ...
            if (RemainingMilliseconds < lead_lowater)
            {
              calc_buffer(sound_buffer, 0, sndbufsize);
            }
            */

            if (AudioBufferCallback != null) AudioBufferCallback(sound_buffer, sndbufsize);
        ...
        void init_sound()
        {
            //audiostream = new AudioStream((int)SAMPLE_FREQ, AudioFormat.Unsigned16Little, SoundChannel.Mono, (short)sndbufsize);
            //Audio.Paused = false;
            //audiostream.Paused = false;
            ready = true; //Audio.AudioStatus == AudioStatus.Playing;
        }
