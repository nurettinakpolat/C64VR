...
namespace SharpC64
{
    public class C64
    {
        ...
        public Action KeyboardCallback = null;
        public C64()
        {
            int i, j;
        ...
        */
        ...
        public void PollKeyboard(int key, bool keydown, bool keyup, bool driect = false)
        {
            TheDisplay.PollKeyboard(key, keydown, keyup, TheCIA1.KeyMatrix, TheCIA1.RevMatrix, ref joykey, driect);
        }
        ...
        public byte joykey;			    // Joystick keyboard emulation mask value
